  ...
  <div class="flex gap-20">
    <div class="">
      <aside class="w-64" aria-label="Sidebar">
        <div style="height: 100vh" class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
          <ul class="flex flex-col gap-8 space-y-2 mt-10">
            ...
            <li>
              <a href="${pageContext.request.contextPath}/admin/logout" class="mt-72 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
